    ...
    return (
        <div className="col-lg-4 col-md-6">
            <input
                ...
                style={{ display: 'none' }}
            />
            <p className="position-relative pt-3 mb-0">Alta Constitutiva: <a href={actaConsUrl} target="_blanck" className="btn btn-edit"><span className="ico-documento"></span> Ver</a></p>
            {
                !show &&
