...
import { EntrepreneurshipInitiative } from './EntrepreneurshipInitiative';

export const CreativityInnovation = () => {
        ...
        <div>
            {
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <h4>Pensamiento Divergente (PD)</h4>
                    <h5>Creatividad e Innovación</h5>
                    <h5>{msjError}</h5>
