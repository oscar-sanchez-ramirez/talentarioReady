...
import { AssertiveCommunication } from './AssertiveCommunication';

export const FrustrationTolerance = () => {
        ...
        <div>
            {
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <h5>Autorregulación y Tolerancia a la frustación</h5>
                    <h5>{msjError}</h5>
