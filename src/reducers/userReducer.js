    ...
    switch (action.type) {
        ...
        case types.userNew:
            return {
                ...
                creativityInnovation: action.payload.creativityInnovation,
                entrepreneurshipInitiative: action.payload.entrepreneurshipInitiative,
                improvisation: action.payload.improvisation,
                problemSolving: action.payload.problemSolving,
                emotionalIntelligence: action.payload.emotionalIntelligence,
                rationalIntelligence: action.payload.rationalIntelligence,
                focus: action.payload.focus,
                collaboration: action.payload.collaboration,
                negotiation: action.payload.negotiation,
                selfConfidence: action.payload.selfConfidence,
                frustrationTolerance: action.payload.frustrationTolerance,
                assertiveCommunication: action.payload.assertiveCommunication,
                conflictManagement: action.payload.conflictManagement,
                resilience: action.payload.resilience,
